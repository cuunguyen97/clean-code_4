...
#define EMBER_AF_GENERATED_EVENT_CODE \
  ...
  extern EmberEventControl eventLightSensorAdcPollingRead; \
  extern EmberEventControl eventScanTempAndHumi; \
  ...
  extern void eventLightSensorAdcPollingReadHandler(void); \
  extern void eventScanTempAndHumiHandler(void); \
...
#define EMBER_AF_GENERATED_EVENTS   \
  ...
  { &eventLightSensorAdcPollingRead, eventLightSensorAdcPollingReadHandler }, \
  { &eventScanTempAndHumi, eventScanTempAndHumiHandler }, \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS   \
  ...
  "Ember af plugin battery monitor read a d c event",  \
  "Event scan sensor",  \
